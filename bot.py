...
async def private_start_handler(message: types.Message):
    ...
    welcome_msg = (
        ...
        f"• نظام إجراء صفقات آلي كل ما عليك هو ربط حسابك بالنظام وهو يقوم بالتداول بدلاً عنكآمان بنسبة 100.\n"
        ...
        f"▫️ أسبوع: <b>150$</b>\n"
        f"▫️ شهر: <b>500$</b>\n"
        f"▫️ 3 أشهر: <b>1,400$</b>\n"
        f"▫️ 6 أشهر: <b>4,200$</b>\n"
        f"▫️ سنة كاملة: <b>8,000$</b>\n\n"
